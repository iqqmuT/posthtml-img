...
module.exports = function (options) {
  ...
  } else if (opts.onInfo && typeof opts.onInfo !== 'function') {
    throw new Error('posthtml-img: option onInfo must be a function')
  }
  ...
  async function handleImage (node, index) {
    ...
    if (opts.onInfo) {
      // send image information to given callback function
      opts.onInfo(imgInfo, index)
    }
